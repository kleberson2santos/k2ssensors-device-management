package com.k2sworks.k2ssensors.device.management.api.config.web;

import com.k2sworks.k2ssensors.device.management.api.client.SensorMonitoringClientBadGatewayException;
